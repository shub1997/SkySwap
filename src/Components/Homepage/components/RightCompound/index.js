  ...
  return (
    <Grid className="right-compound">
      <TextTransition
        ...
        noOverflow
        className="heavy-text mobile-hidden"
      />
      <Typography className="heavy-text mobile-hidden">{firstSectionInfo.headTwo}</Typography>
      <img src={Logo} className="section-one-logo mobile-hidden" alt="logo"/>
